...
Mission-making toolkit for **Project I.G.I.: I'm Going In (2000)**. You don't
need the IGI ToolKit GUI.

You lay out a mission on a 2D map that looks like the in-game map computer:
guards, patrols, pickups, buildings, and new navmesh nodes. Every mission starts
from one of the game's 14 missions, either a copy of it or just its map. Press
**Apply** and the tool builds the mission from that untouched base, compiles
it, and installs it into its own slot in the game's mission list (mission 15,
16, …).
...
- **Limit:** the game moves the ground at most 4 m either way from the
  ...
  list. See [docs/PLAN-ground.md](docs/PLAN-ground.md).
...
models plain. See [docs/PLAN-3d.md](docs/PLAN-3d.md) for the formats.
...
[docs/PLAN-ai.md](docs/PLAN-ai.md).
...
None of these are documented publicly. Each one was found by debugging a crash
or a broken mission.
